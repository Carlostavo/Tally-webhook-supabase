...
export default async function handler(req, res) {
  ...
  try {
    ...
    // console.log("Payload recibido:", JSON.stringify(payload, null, 2)); // Descomenta para depuración
    ...
    const datosEncuesta = {
      ...
      "Se debe separar los desechos solidos segun su tipo (ejemplo: papel - plastico - organico - inorganico)?": payload.data?.["Se debe separar los desechos solidos segun su tipo (ejemplo: papel - plastico - organico - inorganico)?"],
